from flask import Flask,jsonify, render_template,flash,g, request,make_response,redirect, url_for, session
...
def atualizar_acompanhamento():
    ...
    try:
        ...
        flash(f"Erro no MySQL: {err}", "danger")
...
def buscar_cliente_acompanhamento():
    ...
    try:
        ...
        return jsonify({"erro": f"Erro MySQL: {err}"})
...
def buscar_mensagens_acompanhamento(id_cliente):
    ...
    try:
        ...
        return jsonify({"erro": f"Erro MySQL: {err}"}), 500
    except Exception as e:
